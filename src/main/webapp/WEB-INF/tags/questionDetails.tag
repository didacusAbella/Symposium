            ...
            <div class="card-section">
                ...
                <c:choose>
                    <c:when test="${not empty admin}">
                        ...
                        <p>
                        <form action="admin/QuestionController?action=deleteQuestion" method="POST" data-abide novalidate>
                            <input type="hidden" name="questionId" value="${question.id}">
                            <input type="submit" class="button alert" value="Elimina domanda">
                        </form>
                        </p>
