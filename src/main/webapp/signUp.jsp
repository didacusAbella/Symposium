...
<sy:layout title="Symposium-Iscrizione">
    ...
    <p>
		...
		<c:if test="${emailAlreadyExists!=null}">	
   ...
   <span aria-hidden="true">&times;</span>
    ...
    <p>
					<i class="fi-alert"></i><strong>  ${emailAlreadyExists}</strong> </p>
    ...
    <div class="grid-x margin-x align-center">
      <div class="grid small-12 medium-6 large-6 callout primary">
        ...
        <input type="text" placeholder="Nome Utente" name="username"
         ...
         <input type="text" placeholder="Cognome" name="lastName"
						pattern="\w+{4,20}" required />
        ...
        <input type="email" placeholder="Email Ateneo" name="email"
						pattern="[a-z0-9._%+-]+@studenti.unisa.it" required />
        <span class="form-error"> Inserisci una mail valida</span>
        <input type="email" placeholder="Conferma Email Ateneo" required />
         <span class="form-error"> Inserisci una mail valida</span>
        <input type="radio" name="typeGrad" value="triennale" checked
						required>Triennale<br />
