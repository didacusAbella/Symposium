...
<sy:layout title="Symposium-<%--getQuestionTitle() --%>>">
 ...
 <!-- class="float-center" -->
  ...
  <div>
  <form action="AnswerController?action=insertanswer" method="post" data-abide novalidate>
  <label>
  <textarea rows="10" required maxlength="65535" id="answer" name="answer"></textarea>
